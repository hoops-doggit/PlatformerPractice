...
public class SetLevels : MonoBehaviour {
	...
	void Awake() {
		...
		changingBools.Add("Melody", false);
		changingBools.Add("Tape", false);
		changingBools.Add("Glitch", false);
		changingBools.Add("Music", false);
		changingBools.Add("SoundFx", false);
		changingBools.Add("Decimator", false);
	}
